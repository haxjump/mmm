...
lazy_static! {
    ...
    pub static ref NETWORK_MESSAGE_SIZE_COUNT_VEC: IntCounterVec =
    ...
    pub static ref NETWORK_RPC_RESULT_COUNT_VEC: IntCounterVec =
        register_int_counter_vec!(
    ...
    pub static ref NETWORK_PROTOCOL_TIME_HISTOGRAM_VEC: HistogramVec =
...
lazy_static! {
    ...
    pub static ref NETWORK_IP_PENDING_DATA_SIZE_VEC: IntGaugeVec =
    ...
    pub static ref NETWORK_RECEIVED_MESSAGE_IN_PROCESSING_GUAGE: IntGauge =
        register_int_gauge!(
    ...
    pub static ref NETWORK_IP_DISCONNECTED_COUNT_VEC: IntCounterVec =
        register_int_counter_vec!(
