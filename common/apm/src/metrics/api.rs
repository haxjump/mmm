...
lazy_static! {
    pub static ref API_REQUEST_COUNTER_VEC: IntCounterVec = register_int_counter_vec!(
        "muta_api_request_total",
        "Total number of request",
        &["type"]
    )
    .expect("request total");
    pub static ref API_REQUEST_RESULT_COUNTER_VEC: IntCounterVec =
