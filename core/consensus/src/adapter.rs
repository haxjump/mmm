...
use protocol::traits::{
    ...
    ExecutorResp, Gossip, MemPool, MessageTarget, MixedTxHashes, Network, PeerTrust,
    Priority, Rpc, ServiceMapping, Storage, SynchronizationAdapter, TrustFeedback,
};
use protocol::types::{
...
use crate::BlockProofField::{
    BitMap, HashMismatch, HeightMismatch, Signature, WeightNotFound,
};
    ...
    Mapping: ServiceMapping + 'static,
{
    ...
    fn get_metadata(
        ...
        Ok(serde_json::from_str(&exec_resp.succeed_data)
