...
use protocol::traits::{
    CommonConsensusAdapter, ConsensusAdapter, Context, MessageTarget, MixedTxHashes,
    NodeInfo, TrustFeedback,
};
use protocol::types::{
...
fn init_engine(
    init_status: CurrentConsensusStatus,
) -> ConsensusEngine<MockConsensusAdapter> {
    ConsensusEngine::new(
