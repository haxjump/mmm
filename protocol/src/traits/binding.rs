...
use crate::types::{
    Address, Block, Hash, MerkleRoot, Receipt, ServiceContext, SignedTransaction,
};
...
pub trait AdmissionControl {
    fn next<SDK: ServiceSDK>(&self, ctx: ServiceContext, sdk: SDK)
    -> ProtocolResult<()>;
}
